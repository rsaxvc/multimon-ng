...
static inline int is_alphanumeric_page(struct Flex * flex) {
...
static inline int is_numeric_page(struct Flex * flex) {
	if (flex==NULL) return 0;
...
static inline int is_tone_page(struct Flex * flex) {
	if (flex==NULL) return 0;
